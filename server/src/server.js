var isDevEdition,
  ...
  utils_1 = require("./middlewares/utils"),
  app = ((process.env[utils_1.NODE_TLS_REJECT_UNAUTHORIZED] = "0"), new Koa()),
...
function init() {
  ...
  ((port = commanderOption.port || process.env.PORT || 3e3),
    (httpsPort =
...
function handleProtocol(r, o) {
  return __awaiter(this, void 0, void 0, function () {
    var t;
    return __generator(this, function (e) {
      switch (e.label) {
        case 0:
          return commanderOption.http_only ? [4, o()] : [3, 2];
        case 1:
          return (e.sent(), [2]);
        case 2:
          return "http" !== r.protocol
            ? [3, 3]
            : ((r.URL.protocol = "https"),
              (r.URL.port = httpsPort + ""),
              null != (t = null == r ? void 0 : r.URL) &&
                t.toString() &&
                r.redirect(
                  null == (t = null == r ? void 0 : r.URL)
                    ? void 0
